...
namespace QuestionLib
{
	...
	public class Paper
	{
		...
		// (get) Token: 0x06000045 RID: 69 RVA: 0x0000259C File Offset: 0x0000159C
		// (set) Token: 0x06000046 RID: 70 RVA: 0x000025B4 File Offset: 0x000015B4
